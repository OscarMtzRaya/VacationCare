      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-6">
          <div class="about-tab-image-grid text-center">
            <div class="about-video d-inline-block" style="box-shadow: 0px 0px 5px black;">
          ...
          <div class="about-tab-wrap">
            ...
            <div class="tab-content about-tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="about-pills1" role="tabpanel" aria-labelledby="pills-about1">
                <p class="p-4">
                We are a vacation care club, where our clients receive a completly customized experience at all times, any time of the year, form your arrival to your departure, we'll solve any inconvenience for you.
                </p>
              </div>
              <div class="tab-pane fade" id="about-pills2" role="tabpanel" aria-labelledby="pills-about2">
                <p class="p-4">
                Be the number one option nationwide, for planning you vacations, offering a customized experience like no other, covering every aspect, like accommodations, transportation, tours, concierge, and more.
                </p>
              </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="guide-card-gamma">
          ...
          <div class="guide-content">
            <h4 class="guide-name">Sebastian Mateo</h4>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="guide-card-gamma">
          ...
          <div class="guide-content">
            <h4 class="guide-name">Theodore Aiden</h4>
            <h6 class="guide-designation">Tour Guide</h6>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6">
        <div class="guide-card-gamma">
          ...
          <div class="guide-content">
            <h4 class="guide-name">Lincoln Anthony</h4>
            <h6 class="guide-designation">Tour Guide</h6>
          </div>
        </div>
      </div>
        ...
        <div class="blog-card-gamma">
          ...
          <div class="blog-content">
            <div class="blog-body-top">
              <a href="#" class="blog-writer"><i class="bi bi-person-circle"></i> By John Smith
              </a>
              <a href="#" class="blog-comments"><i class="bi bi-calendar3"></i> Novembar 16, 2021</a>
            </div>
            <h4 class="blog-title">
              <a href="blog-details.html">vitae tempor convallis, mi ligula an suscipit nunc, ornare
                suscipit.</a>
            </h4>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blog-card-gamma">
          ...
          <div class="blog-content">
            ...
            <h4 class="blog-title">
              <a href="blog-details.html">Mauris commodo massa vel diamnat feugiat sagittis Nunc
                maxim.</a>
            </h4>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="blog-card-gamma">
          ...
          <div class="blog-content">
            ...
            <h4 class="blog-title">
              <a href="blog-details.html">Nulla urna leo, volutpat eu maurisa eget luctus malesuada
                urna.</a>
            </h4>
          </div>
        </div>
